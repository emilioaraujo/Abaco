...
public class ListCategoryModel extends ArrayAdapter<String> {
    private final Activity context;
    private ArrayList<String> title = new ArrayList<String>();
    private ArrayList<String> description = new ArrayList<String>();
    private ArrayList<Integer> imageId = new ArrayList<Integer>();

    public ListCategoryModel(Activity context,
                             ArrayList<Integer> imageId,
                             ArrayList<String> title,
                             ArrayList<String> description) {
        super(context, R.layout.list_category_model, title);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.list_category_model, null, true);
